...
public class mostrarResultados extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        for(Object insc : inscriptos){
            ...
            if(datosins.getEstado().toString().equals("ACEPTADA")||datosins.getEstado().toString().equals("CERRADA")){
                String nota = "";
                String nota2 = "";
                if(datosins.getNota()==0){
                    nota="PENDIENTE";
                }
                else{
                    nota=Integer.toString(datosins.getNota());
                }
                if(opcion!=null && !opcion.equals("")){
                    nota2 = "<td name=\"nota\" id=\"nota\">" + nota + "</td>";
                }
                result1 = result1 + "<tr><td name=\"est\" id=\"est\">" + nombre + "</td>" 
                + "<td name=\"fech\" id=\"fech\">" + datosins.getFechaInsc().toString() + "</td>" +
                "<td name=\"estado\" id=\"estado\">" + datosins.getEstado().toString() + "</td>"+ nota2 + "</tr>";
            }
        }
