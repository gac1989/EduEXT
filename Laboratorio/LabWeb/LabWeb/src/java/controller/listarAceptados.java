...
public class listarAceptados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet listarAceptados</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet listarAceptados at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(curso!=null && nick2!=null && port.esDocente(nick2)){
            ...
            for(DatosEdicion ed : ediciones){
                ...
                if((ed.getEstado()==EstadoEdicion.ABIERTA || ed.getEstado()==EstadoEdicion.CERRADA) && ed.getCurso().equals(curso)){
